...
const string strMessageMagic = "uBitcoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 5256001)
    {
        nSubsidy = 0.399 * COIN;
        return nSubsidy + nFees;
    }   
    
    else if(pindexBest->nHeight > 5256000)
    {
        nSubsidy = 0.0002 * COIN;
        return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "uBitcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "uBitcoincoin blockchain start on 2017/10/10 20:18:18";
        CTransaction txNew;
        txNew.nTime = 1507691898;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1507691898;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3511087;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x92b1e41bd5dbc7741f0dc9d33ed4d752792b391100ba663106fdc064354340d5"));
